...
public class December11_TaskA implements Task {
    ...
    private final class AStarCoordinate implements Comparable<AStarCoordinate>{
        ...
        public AStarCoordinate getParent() {
            return this.parent;
        }
    ...
    private AStarCoordinate walkDistance(final List<String> input) {
        ...
        return new AStarCoordinate(currentX, currentY);
    }
